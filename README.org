...
Then run [[file:results_copy.R]] to copy CSV files (and R analysis
scripts) to a sub-directory of results (named using the current date).
The reproduced results files are named =NSCH_*.csv= in your results
sub-directory.
